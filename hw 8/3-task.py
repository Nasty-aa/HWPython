...
# Здесь пишем код
def segment(tuple1: tuple, tuple2: tuple):
    """

    :param tuple1: Кортеж с координатами точек (x1, y1)
    :param tuple2: Кортеж с координатами точек (x2, y2)
    :return: Возвращаем сумму всех координат
            *Если был передан не корректные данные то возвращается текст исключение задом наперед
    """
    try:
