...
def treatment_sum(our_tuple: tuple):
    ...
    """
    :param our_tuple: Кортеж из 2 элементов
    :return: Если более 2 элементов в кортеже возвращает - Много данных
             Если 2 элемента в кортеже возвращает - сумму двух элементов
             Если разные в кортеже типы возвращает - Нельзя сложить эти данные
             Если менее 2 элементов в кортеже возвращает - Недостаточно данных
    """
