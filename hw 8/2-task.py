...
class Trigon:
    def __init__(self, *args):
        ...
        :param args: Не известное количество аргументов

        1) Если в класс передана хотя бы одна сторона строкой, то возвращается TypeError('Стороны должны быть числами')
        2) Если в класс передана хотя бы одна сторона 0 или отрицательным числом, то возвращается -
           ValueError('Стороны должны быть положительными')
        3) Если в класс передано не 3 аргумента, то возвращается  -
           IndexError(f'Передано {*количество*)} аргументов, а ожидается 3')
